        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-5 col-sm-4">
                    <div class="logo">
                            <a href="<?= \yii\helpers\Url::home(); ?>"><span class="sk-logo">Sk</span> <span class="sk-text">рыбачёк</span><?php /*echo Html::img('@web/images/home/logo.png',['alt'=>'logo']) */?></a>
                    </div>
                </div>
                ...
                <div class="mainmenu pull-right">
                    <ul class="nav navbar-nav collapse navbar-collapse">
                        ...
                        <li class="hidden-md hidden-sm hidden-lg"><a href="#" onclick="return getCart()"><i class="fa fa-shopping-cart"></i> Моя корзина</a></li>
                        <li class="hidden-md hidden-sm hidden-lg"><a href="<?= \yii\helpers\Url::to(['admin/']) ?>"><i class="fa fa-lock"></i> Кабинет</a></li>
                    <?php if(!Yii::$app->user->isGuest){ ?>
                        <li class="hidden-md hidden-sm hidden-lg"><a href="<?= \yii\helpers\Url::to(['/site/logout']) ?>"><i class="fa fa-user"></i> <?= Yii::$app->user->identity['username'] ?> (Выход)</a></li>
                    <?php } ?>
                    </ul>
                </div>
            </div>
